function makeServiceAjax() {
    var service = {
        ...
        updatePersonnage: updatePersonnage
    };
    ...
    function updatePersonnage(idPersonnage, idStatistique, etat, nom, prenom, pv, pvMax, race, genre, age, niveau, armure, classe, lore, force, agilite,
        social, perception, mental, intelligence, constitution) {
        var url = "./php/update.php?case=personnage&idPersonnage=" + idPersonnage + "&idStatistique=" + idStatistique + "&etat=" + etat + "&nom=" + nom + "&prenom=" + prenom +
            "&pv=" + pv + "&pvMax=" + pvMax + "&race=" + race + "&genre=" + genre + "&age=" + age + "&niveau=" + niveau + "&armure=" + armure + "&classe=" + classe + "&lore=" + lore +
            "&force=" + force + "&agilite=" + agilite + "&social=" + social + "&perception=" + perception + "&mental=" + mental + "&intelligence=" + intelligence +
        ...
        return new Promise(function (resolve, reject) {
            ...
            http.onload = function () {
                if (http.status == 200) {
                    resolve(this.response);
                } else reject("Erreur updatePersonnage 1 : " + http.serverResponse);
            };
            http.onerror = function () {
                reject("Erreur updatePersonnage 2 : " + http.serverResponse);
            };
        });
    }
