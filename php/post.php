...
switch ($_GET['case']) {
	case 'personnage':
		...
		addPersonnage($bdd, $_SESSION['idUtilisateur'], 2, $_GET["nom"], $_GET["prenom"], $_GET["niveau"], $_GET["age"], $_GET["race"], $_GET["classe"], $_GET["genre"], $_GET["pv"], $_GET["pv"], 0, $idStat, $_GET["lore"]);
		break;
